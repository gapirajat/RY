  ...
  return (
    <>
      ...
      <div ref={ref} className="h-[70dvh] flex flex-col items-center relative">
        ...
        <button className={`absolute bottom-[2%] bg-pink-500 text-white font-semibold py-2 px-8 rounded-full border-[1px] transition-all hover:bg-pink-600 opacity-0 ${hover == false ? 'duration-[2000ms] delay-[3000ms]' : 'duration-100 delay-0 scale-90'} ${isIntersecting ? 'opacity-[95%] -translate-y-[2rem]' : 'translate-y-[4rem]'}`} onMouseDown={() => setHover(true)}>
          Reach out
        </button>
      </div>
